...
public class customersBonus{
	...
	public static void main(String [] args) throws Exception
	{
		...
		job2.setJarByClass(customersBonus.class);
					...
					if(totalSpent<=(605.79/4))
					{
						if(Income<51687.45) {
							try {
								...
								if (result == 0)
									con.write(new Text("Bronze"), new LongWritable(Id));
								else
									con.write(new Text("Paper"), new LongWritable(Id));
